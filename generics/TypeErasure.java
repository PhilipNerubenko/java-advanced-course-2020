...
public class TypeErasure {
    ...
    */
   public void abc(Info<String> info) { // Erasure of method abc(Info<String>) is the same as another method in type TypeErasure
    ...
    */
   public void abc(Info<Integer> info) { // Erasure of method abc(Info<Integer>) is the same as another method in type TypeErasure
