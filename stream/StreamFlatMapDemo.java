...
public class StreamFlatMapDemo {
    ...
    * It demonstrates the usage of Java Streams and flatMap to process a list of faculties and their students.
    *
   ...
   public static void main(String[] args) {
       ...
       // Use flatMap to flatten the list of faculties and their students, and print the names of the students
