...
public class StreamCollectorsDemo {
   ...
   public static void main(String[] args) {
       ...
       Map<Integer, List<StudentFilter>> map1 = students.stream().map(element -> {
       ...
       // Partition the students into two groups based on their average grade using Collectors.partitioningBy
       Map<Boolean, List<StudentFilter>> map2 = students.stream()
           .collect(Collectors.partitioningBy(element -> element.getAvgGrade() > 3.5));
