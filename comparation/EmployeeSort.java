...
/**
* Class EmployeeSort demonstrates sorting a list of EmployeeComparator objects using a SalaryComparator.
*/
...
/**
* Class EmployeeComparator implements Comparable<EmployeeComparator> to compare EmployeeComparator objects based on their id.
*/
class EmployeeComparator implements Comparable<EmployeeComparator> {
   ...
   public String toString() {
       return "EmployeeComparator [id=" + id + ", name=" + name + ", surname=" + surname + ", salary=" + salary + "]";
   }
...
/**
* Class IdComparator implements Comparator<EmployeeComparator> to compare EmployeeComparator objects based on their id.
*/
...
/**
* Class NameComparator implements Comparator<EmployeeComparator> to compare EmployeeComparator objects based on their name.
*/
...
/**
* Class SalaryComparator implements Comparator<EmployeeComparator> to compare EmployeeComparator objects based on their salary.
*/
