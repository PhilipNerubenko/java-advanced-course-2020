...
/**
 * Class ComparableEmployeeExample demonstrates sorting a list of EmployeeComparable objects using
...
/**
 * Class EmployeeComparable implements Comparable<EmployeeComparable> to compare EmployeeComparable
...
class EmployeeComparable implements Comparable<EmployeeComparable> {
  ...
  public String toString() {
    return "EmployeeComparable [id=" + id + ", name=" + name + ", surname=" + surname
        + ", salary=" + salary + "]";
  }
  ...
  //    @Override
  //    /**
  //     * Compares this EmployeeComparable object with the specified EmployeeComparable object for
  //     order.
  //     * @param anotherEmployee the EmployeeComparable object to be compared.
